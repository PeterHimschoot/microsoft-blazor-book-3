let showOrUpdate = (elementId, zoom, markers) => {
  ...
  if (!elem.map) {
    ...
    L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoicGV0ZXJoaW1zY2hvb3QiLCJhIjoiY2twbDF3YXUwMDFkNTJ3bXU3bnFkNmY3MiJ9.HeBR5xRZegWGb6vu22vDPw', {
      attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
      maxZoom: 18,
      id: 'mapbox/streets-v11',
      tileSize: 512,
      zoomOffset: -1,
      accessToken: 'pk.eyJ1IjoicGV0ZXJoaW1zY2hvb3QiLCJhIjoiY2twbDF3YXUwMDFkNTJ3bXU3bnFkNmY3MiJ9.HeBR5xRZegWGb6vu22vDPw'
    }).addTo(elem.map);
  }
